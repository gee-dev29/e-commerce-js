...
export const resetPasswordTemplate = (token, name) => {
  ...
  <body style="background-color:#f6f9fc;padding:10px 0">
    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="max-width:37.5em;background-color:#ffffff;border:1px solid #f0f0f0;padding:45px">
      <tbody>
        <tr style="width:100%">
          <td><img alt="KNcloset" height="80" width="80"src="https://knclosets.com/assets/logo-DVIgV1q8.webp" style="display:block;outline:none;border:none;text-decoration:none" width="40" />
      ...
      <body style="background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,Oxygen-Sans,Ubuntu,Cantarell,&quot;Helvetica Neue&quot;,sans-serif">
        <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="max-width:37.5em;margin:0 auto;padding:20px 0 48px">
          <tbody>
            <tr style="width:100%">
              <td>
                <img alt="KNcloset" height="80" width="80" src="https://knclosets.com/assets/logo-DVIgV1q8.webp" style="display:block;outline:none;border:none;text-decoration:none;margin:0 auto" width="170" />
  ...
  <td>
    ...
    <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
      <tbody>
        <tr>
          <td>
            <img alt="KNcloset" height="80" width="80" src="https://knclosets.com/assets/logo-DVIgV1q8.webp" style="display: block; outline: none; border: none; text-decoration: none;" />
          </td>
